...
async function bootstrap() {
    console.log('');
    console.log('=================================================');
    console.log('  NJILA - njila-search-service');
    console.log('=================================================');
    console.log('');
    ...
    const PORT = parseInt(remoteConfig['server.port'] || process.env.PORT || 8086);
    ...
    app.listen(PORT, () => {
        console.log(`[START] njila-search-service demarre sur le port ${PORT}`);
        console.log(`[START] Health : http://localhost:${PORT}/api/search/health`);
    });
}
