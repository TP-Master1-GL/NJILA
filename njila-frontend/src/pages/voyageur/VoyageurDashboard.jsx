      ...
      <div className="max-w-4xl mx-auto px-4 py-6 md:py-10">
        ...
        <div className="anim-1 relative overflow-hidden bg-gradient-to-br from-[#135bec] to-blue-800 rounded-2xl p-6 mb-6 text-white">
          ...
          <div className="relative z-10 flex items-center justify-between">
            ...
            {/* ✅ Logo NJILA dans le hero (remplace les initiales) */}
            <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center border-2 border-white/30 backdrop-blur-sm overflow-hidden flex-shrink-0 p-1">
              <img
                src="/NJILA_logo.png"
                alt="NJILA"
              ...
              <div
                style={{ display: "none" }}
                className="w-full h-full items-center justify-center text-2xl font-black text-white"
              >
        ...
        <div className="anim-3 grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
          {[
            ...
            <div
              key={title}
              className={`relative overflow-hidden bg-gradient-to-r ${gradient} rounded-2xl p-5 text-white cursor-pointer card-hover`}
            >
        ...
        <div className="anim-4 bg-white rounded-2xl border border-slate-100 shadow-sm p-5 mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={() => navigate("/recherche")}
              className="text-xs text-[#135bec] font-bold hover:underline"
            >
              Voir tout
            </button>
          </div>
