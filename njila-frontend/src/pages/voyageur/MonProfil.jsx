...
import {
  User, Mail, Phone, MapPin, Camera, ArrowLeft,
        ...
        <div className="pg2 bg-white rounded-2xl border border-slate-100 shadow-sm p-6 mb-4">
          <div className="flex items-center gap-4 mb-6">
            <div className="relative flex-shrink-0">
              ...
              <button className="absolute -bottom-1.5 -right-1.5 w-8 h-8 bg-white border-2 border-slate-100 rounded-xl flex items-center justify-center hover:bg-slate-50 shadow-sm transition-colors">
                <Camera className="w-3.5 h-3.5 text-slate-500" />
              </button>
            </div>
            <div className="flex-1 min-w-0">
              <h2 className="text-xl font-extrabold text-slate-900 truncate">{user?.prenom} {user?.nom}</h2>
            ...
            <button
              ...
              className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all active:scale-90 ${
                editing ? "bg-red-50 text-red-500 hover:bg-red-100" : "bg-slate-100 text-slate-500 hover:bg-slate-200"
              }`}
            >
