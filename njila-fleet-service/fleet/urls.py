...
urlpatterns = [
    ...
    path('agences/<uuid:id_agence>/profil/', views.AgenceProfilPublicView.as_view(), name='agence-profil-public'),
    ...
    path('api/health/rabbitmq/', views.rabbitmq_health_check, name='rabbitmq-health'),
]