...
public class UserController {
    ...
    @GetMapping("/users/avis/agence/{agenceId}")
    @Operation(
    ...
    @GetMapping("/users/avis/agence/{agenceId}/stats")
    @Operation(
    ...
    @PostMapping("/users/admin/managers-globaux")
    @Operation(
    ...
    @GetMapping("/users/agences/{agenceId}/staff")
    @Operation(
    ...
    @GetMapping("/users/agences/{agenceId}/employes")
    @Operation(
    ...
    @GetMapping("/users/agences/{agenceId}/filiales/{filialeId}/employes")
    @Operation(
    ...
    @PostMapping("/users/agences/{agenceId}/managers-locaux")
    @Operation(
    ...
    @GetMapping("/users/filiales/{filialeId}/employes")
    @Operation(
    ...
    @GetMapping("/users/filiales/{filialeId}/guichetiers")
    @Operation(
    ...
    @GetMapping("/users/filiales/{filialeId}/chauffeurs")
    @Operation(
    ...
    @PostMapping("/users/filiales/{filialeId}/guichetiers")
    @Operation(
    ...
    @PostMapping("/users/filiales/{filialeId}/chauffeurs")
    @Operation(
