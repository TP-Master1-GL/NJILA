...
/**
 * Configuration RabbitMQ — user-service v1.4.
 *
 * Queues consommées :
 * ┌────────────────────────────────────────┬────────────────────────────┬────────────────────────┐
...
public class RabbitMQConfig {
    ...
    public static final String QUEUE_STAFF_CREATED       = "njila.user.staff-created.queue";
    ...
    @Bean public Queue staffCreatedQueue()       { return durableQueue(QUEUE_STAFF_CREATED); }
    ...
    @Bean public Binding bindingStaffCreated() {
        return BindingBuilder.bind(staffCreatedQueue()).to(userExchange()).with(KEY_STAFF_CREATED);
    }
    @Bean public Binding bindingAgenceCreated() {
        return BindingBuilder.bind(agenceCreatedQueue()).to(fleetExchange()).with(KEY_AGENCE_CREATED);
    }
    @Bean public Binding bindingFilialeCreated() {
        return BindingBuilder.bind(filialeCreatedQueue()).to(fleetExchange()).with(KEY_FILIALE_CREATED);
    }
